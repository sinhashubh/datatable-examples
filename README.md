...
<span>Example of Table Meta format that should be returned by GetTableMeta request</span>
...
<span> Example of Table Data format that should be returned by GetTableData request</span>
